...
組み立てやすくするためにケースとともに[スタンド](/3d_model/stand.stl)も一緒に印刷しておくと便利です。
...
- 最後に印刷した3Dプリントケースをかぶせネジを止め、ゴム足を貼り付けたら完成です。
  - プランジャーが下に落ちきった状態にしておかないと底面のネジ止めがうまくできないので、[スタンド](/3d_model/stand.stl)などを使ってプランジャーが落ちきった状態で作業をすることをおすすめします。
